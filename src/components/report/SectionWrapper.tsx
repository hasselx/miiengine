...
const SectionWrapper = ({ num, title, score, children }: Props) => (
  <div className="bg-card border border-border">
    <div className="flex items-center gap-3 px-5 py-3.5 border-b border-border bg-accent-area">
      ...
      <span className="font-mono text-[12px] tracking-[2px] uppercase text-ink font-semibold">{title}</span>
      {score && <span className="ml-auto font-mono text-[14px] font-semibold text-ink">{score}</span>}
    </div>
